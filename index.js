...
let res = (0, node_sql_1.SELECT)(["firstName fname", "lastName lname", "status.from"], (0, node_sql_1.FROM)(data));
console.log(res);
let resline = (0, node_sql_1.SELECT)("firstName, lastName, status.from from, status.address.city city", (0, node_sql_1.FROM)(data));
console.log(resline);
